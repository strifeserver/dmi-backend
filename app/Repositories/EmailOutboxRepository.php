...
use App\EmailOutbox;
use App\Interfaces\EmailOutboxInterface;
use App\Services\AccountService;

class EmailOutboxRepository implements EmailOutboxInterface
{
    /**
     * @param EmailOutbox $db
     */
    public $errors = [];
    public function __construct(EmailOutbox $db)
    {
        $this->db_table = $db;
    }
                ...
                switch ($key) {
                    case 'all':
                        ...
                        if (!empty($value->filter)) {
                            ...
                            $blocked_fields = ["created_at", "updated_at"];
