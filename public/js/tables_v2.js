  ...
  */
  CORE_Framework.createEdit = function (config) {
    ...
    return this.toNode(/*html*/
      ...
      href="${config.href}"
      title="Edit"
      class="btn btn-icon btn-primary btn-simple update_btn tbl_btn">
      <i class="feather icon-edit"></i>
      </a>`);
  };
  ...
  CORE_Framework.createDelete = function (config) {
    return this.toNode(/*html*/
      `<button
        data-id="${config.id}"
        title="Delete"
        class="btn btn-icon btn-danger delete_btn tbl_btn ${config?.classList}"
        data-toggle="modal"
        data-target="#modal">
  ...
  CORE_Framework.createLock = function (config) {
    return this.toNode(/*html*/
      `<button
          ...
          class="btn btn-icon tbl_btn ${config.isLocked ? 'btn-light' : 'btn-success'} lock_btn ${config?.classList}"
          data-toggle="modal"
          data-target="#lock">
  ...
  CORE_Framework.createTemp = function (config) {
    return this.toNode(/*html*/
      `<button
            ...
            class="btn btn-icon btn-info temppass_btn tbl_btn ${config?.classList}"
            data-toggle="modal"
  ...
  CORE_Framework.createcustom_btn1 = function (config) {
    return this.toNode(/*html*/
      `<button
        ...
        class="btn btn-icon tbl_btn ${config.btn_type} custom_btn ${config?.classList}"
        data-toggle="modal"
