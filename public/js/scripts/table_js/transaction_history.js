  ...
  function makeControls() {
    const controls = [
      ...
      },
      {
        ...
        width: 250,
        cellRenderer: function (params) {
          if (!params.data || !params.data.payment_url) return; // Not fully loaded yet or payment_url does not exist
          const root = document.createElement('div');
          const paymentLink = document.createElement('a');
          paymentLink.href = params.data.payment_url;
          paymentLink.textContent = 'Payment Link';
          paymentLink.setAttribute('target', '_blank');
          root.appendChild(paymentLink);
          return root;
        },
      },
