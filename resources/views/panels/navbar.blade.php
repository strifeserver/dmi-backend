            ...
            <!-- <ul class="nav navbar-nav">
              <li class="nav-item d-none d-lg-block"><a class="nav-link bookmark-star"><i
                ...
                <div class="bookmark-input search-input">
                  ...
                  <input class="form-control input" type="text" placeholder="Explore Navigations..." tabindex="0"
...
<!--             <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i
              ...
              <div class="search-input">
                ...
                <input class="input" type="text" placeholder="Explore Navigations..." tabindex="-1"
                  data-search="laravel-search-list" />
            ...
            <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#"
                data-toggle="dropdown" style="display: none;"><i class="ficon feather icon-bell"></i><span
                  class="badge badge-pill badge-primary badge-up">5</span></a>
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                <li class="dropdown-menu-header">
                  <div class="dropdown-header m-0 p-2">
                    <h3 class="white">5 New</h3><span class="grey darken-2">App Notificationsa</span>
                  </div>
                </li>
            ...
            <a class="dropdown-toggle dropdown-user-link nav-link nav-link-label" href="#" data-toggle="dropdown">
                <div class="user-nav d-sm-flex d-none">
                  <span class="user-name text-bold-600">{{Auth::user()->first_name}} {{Auth::user()->last_name}} <i class="feather icon-chevron-down"></i>
                  </span>
              ...
              <div class="dropdown-menu dropdown-menu-right">
                   <a class="dropdown-item" href="{{url('users/account_settings')}}"><i class="feather icon-settings"></i> Account Settings</a>
                   <!--  <a class="dropdown-item" href="app-email"><i
