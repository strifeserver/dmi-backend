  ...
  <div class="card">
    <div class="card-content">
      <div class="card-body">
        ...
        <div id="myGrid" class="aggrid ag-theme-material"  style="min-width: 100%;"></div>
      </div>
    </div>
  </div>
</section>
...
columnDefs = 
    { headerName: 'CONTROLS',field: 'id',
        cellRenderer: function(pa) {
          var url = '{{ route("navigations.edit", ":id") }}';
          url = url.replace(':id', pa.value);

          var url2 = '{{ route("navigations.destroy", ":id") }}';
          url2 = url2.replace(':id', pa.value);

          var url4 = '{{ route("navigations.destroy", ":id") }}';
          ...
          deletebtn.addEventListener('click', function() {
              var data_id = $(this).data("id"); 
                var url = '{{ route("navigations.destroy", ":id") }}';
