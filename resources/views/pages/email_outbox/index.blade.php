                    ...
                    <div class="btn-dropdown ">
                      <div class="btn-group dropdown actions-dropodown">
                        ...
                        <div class="dropdown-menu">
                          @can('add')
                          <a class="dropdown-item " href="{{ route('email_outbox.create') }}"><i class="feather icon-clipboard"></i> Create</a>
                          @endcan
                          @can('export')
...
{
  var edit_url = '{{ route("email_outbox.edit", ":id") }}';
  var delete_url = '{{ route("email_outbox.destroy", ":id") }}';
