            ...
            <div class="row">
              @foreach ($data_filters as $data_filter)
                @if($data_filter['filter_type'] == 'dropdown_filter')
                  <div class="col-12 col-sm-6 col-lg-3">
                      ...
                      <fieldset class="form-group">
                        <select name="{{$data_filter['filter_code']}}" class="filter_data select2 form-control {{$data_filter['filter_code']}}" id="{{$data_filter['filter_code']}}" >
                          <option value="">All</option>
                          @foreach ($data_filter['dropdown_data'] as $dropdown_data)
                           <option value="{{$dropdown_data['value']}}">{{$dropdown_data['status_name']}}</option>
                          @endforeach
                        </select>
                      </fieldset>
                  </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    ...
                    <fieldset class="form-group">
                        <input type="text" name="from" id="from" class="filter_data form-control format-picker"
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    ...
                    <fieldset class="form-group">
                        <input type="text" name="to" id="to" class="filter_data form-control format-picker" id="cal-start-date to"
...
<div class="modal fade" id="custom_modal" tabindex="-1" role="dialog"
  aria-labelledby="custom_modal_title" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
    role="document">
    <div class="modal-content">
      <div class="modal-header">
...
<!-- <script src="{{ asset('js/scripts/table_js/table_v2.js') }}"></script> -->
<!-- <script src="{{ asset('js/scripts/table_js/table_v2.js') }}"></script> -->
...
if (table_version == 'v2')
{
    js.src = "{{ asset('js/scripts/table_js/users.js') }}";
}
