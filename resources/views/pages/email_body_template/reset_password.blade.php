...
<body>
  ...
  border-radius: 5px;
  display: inline-block;">
            <p><a href="{{$reset_password_link}}" target="_blank">Click Here to reset password</a></p>
	      <!-- <p style="display: inline-block; font-weight: bold; font-size: 20px;">{{ $reset_password_link }}</p> -->
	    </div>
