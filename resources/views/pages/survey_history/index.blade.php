                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="ag-grid-btns d-flex justify-content-between flex-wrap mb-1">
                                ...
                                <div class="dropdown sort-dropdown mb-1 mb-sm-0" hidden>
                                ...
                                <div class="ag-btns d-flex flex-wrap ">
                                    <div class="col-md-12 mb-1">
                                        @can('add')
                                            <a class=" btn btn-primary" href="{{ route('survey_history.create') }}"><i
                                                    class="feather icon-clipboard"></i> Create</a>
                                        @endcan
                                        {{-- <button class="btn btn-primary" id="filterClick">Request Survey</button> --}}
                                    </div>
                                    <br>
