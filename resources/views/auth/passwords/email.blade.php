...
.card.bg-authentication.rounded-0.mb-0 {
   ...
   button.btn.btn-primary.btn-block.px-75.waves-effect.waves-light {
                ...
                <form method="POST" action="{{ url('forgot-password') }}">
                  ...
                  <div class="form-label-group">
                    ...
                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                      name="email" value="{{ old('email') }}" placeholder="Email" required autocomplete="off"
                      autofocus>
...
<!-- <script>
  ...
  if(!x.msg) {
    ...
    if(x.val == 1) {
      ...
      document.getElementById('alert').innerHTML = x.msg;
      setTimeout(function(){
        document.getElementById('alertDisplay').style.display = 'none';
